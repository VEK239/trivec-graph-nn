...
if __name__ == '__main__':
    ...
    NEPTUNE_API_TOKEN = "eyJhcGlfYWRkcmVzcyI6Imh0dHBzOi8vYXBwLm5lcHR1bmUuYWkiLCJhcGlfdXJsIjoiaHR0cHM6Ly9hcHAubmVwdHVuZS5haSIsImFwaV9rZXkiOiI2YTg5NDE1MS04ODA3LTQ1ZGEtODBjMi01ZjVmNzM4ZjUxZTAifQ=="

    if args.log:
        import neptune

        neptune.init(args.neptune_project, NEPTUNE_API_TOKEN)
